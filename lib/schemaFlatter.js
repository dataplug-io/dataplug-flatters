...
class SchemaFlatter {
    ...
    _.forOwn(definition.properties, (propertyDefinition, propertyName) => {
      ...
      if (type === 'object') {
        ...
        if (itemDefinition.type === 'object') {
          ...
          throw new Error(`Not supported: '${entityFqName}' has a multi-dimensional array in '${propertyName}' property`)
          ...
          throw new Error(`Not supported: '${entityFqName}' has an unsupported array item type in '${propertyName}' property: ${itemDefinition.type}`)
        }
        field.type += '[]'
      } else {
  ...
  _flattenEntityDefinedArrayProperties (context, entityContext, entityFqName, definition) {
    ...
    entityContext.arrayProperties.forEach((propertyName) => {
      ...
      this._flattenEntity(context, subentityFqName, itemDefinitionPointer, itemDefinition, inheritedFields)
